...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/ObbySwing_VK.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/ObbySwing_VK.data.unityweb',
                        frameworkUrl: 'Build/ObbySwing_VK.framework.js.unityweb',
                        codeUrl: 'Build/ObbySwing_VK.wasm.unityweb',
                        streamingAssetsUrl: 'StreamingAssets',
                        companyName: 'DefaultCompany',
                        productName: 'ObbySwingBrainrotsSteal',
